...
| 項目 | 内容 |
|---|---|
| 正本 | [`docs/specifications/SPEC001.md`](../specifications/SPEC001.md)（2026-08-06改訂、CHG-014〜CHG-036） |
...
自動テストは MOD 側 142 件、EDI 側 135 件が通っている。ここに書くのは**自動テストでは原理的に確認できないもの**に限る。
